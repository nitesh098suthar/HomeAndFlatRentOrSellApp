...
export const list = [
  ...
  },
  {
    ...
    name: "Om Pyari Properties",
    location: "Ashok Nagar, Udaipur",
    category: "For Sale",
    price: "12,88,000",
    type: "Condos",
  },
  ...
  },
  {
    ...
    location: "Sukhadia Circle, Udaipur",
    category: "For Sale",
    price: " 2,742",
    type: "Apartment",
  },
...
export const location = [
  ...
  {
    id: 3,
    name: "Durga Nursery Road,  Udaipur",
    Villas: "12 Villas",
    Apartments: " 10 Apartments",
    Offices: "07 Offices",
...
export const team = [
  ...
  },
  {
    list: "38",
    cover: "../images/customer/team-5.jpg",
    address: "Bora Ganesh Ji, Udaipur",
    name: "Jagat Singh",
    icon: [<i className='fa-brands fa-facebook-f'></i>, <i className='fa-brands fa-linkedin'></i>, <i className='fa-brands fa-twitter'></i>, <i className='fa-brands fa-instagram'></i>],
  },
]
